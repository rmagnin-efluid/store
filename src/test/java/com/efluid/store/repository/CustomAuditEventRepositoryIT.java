package com.efluid.store.repository;

import com.efluid.store.StoreApp;
import com.efluid.store.config.Constants;
import com.efluid.store.config.audit.AuditEventConverter;
import com.efluid.store.domain.PersistentAuditEvent;
...
import static com.efluid.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
